...
`GetSetting` returns the bare [`Setting`](https://pkg.go.dev/github.com/blrvio/go-unifi/v2/unifi#Setting)
...
[pkg.go.dev](https://pkg.go.dev/github.com/blrvio/go-unifi/v2/unifi).
...
<Cards>
  ...
  <Card title="unifi on pkg.go.dev" href="https://pkg.go.dev/github.com/blrvio/go-unifi/v2/unifi#Setting">
