...
Every import path changes from `github.com/blrvio/go-unifi/unifi` to
`github.com/blrvio/go-unifi/v10/unifi`. This is a Go-modules requirement for a new major version.
