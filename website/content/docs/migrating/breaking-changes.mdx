...
2.0.0 migration (epic [#117](https://github.com/blrvio/go-unifi/issues/117)). It is keyed to 10 breaking
...
**Import-path change (compile break).** All import paths change from `github.com/blrvio/go-unifi/unifi`
to `github.com/blrvio/go-unifi/v10/unifi`. Update `go.mod` with `go get github.com/blrvio/go-unifi/v10`
...
**Status: DONE** — landed in issue [#125](https://github.com/blrvio/go-unifi/issues/125) (API-key-only auth).
...
**Status: DONE** — landed in PR [#119](https://github.com/blrvio/go-unifi/pull/119).
