...
**user**, represented by [`unifi.User`](https://pkg.go.dev/github.com/blrvio/go-unifi/v10/unifi#User). The
...
A [`unifi.UserGroup`](https://pkg.go.dev/github.com/blrvio/go-unifi/v10/unifi#UserGroup) caps a client's
...
A [`unifi.Account`](https://pkg.go.dev/github.com/blrvio/go-unifi/v10/unifi#Account) is a RADIUS user account,
