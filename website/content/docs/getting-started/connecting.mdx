...
[`*unifi.ClientConfig`](https://pkg.go.dev/github.com/blrvio/go-unifi/v2/unifi#ClientConfig). Only `URL` and
...
[`ClientConfig` on pkg.go.dev](https://pkg.go.dev/github.com/blrvio/go-unifi/v2/unifi#ClientConfig).
